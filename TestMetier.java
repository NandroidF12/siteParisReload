...
public class TestMetier {
	...
	public static void main (String [] args) {
		...
		testConstructeurSiteDeParisMetier(); // done
		testValiditePasswordGestionnaire(); // done
		
		testInscrireDesinscrireJoueur(); // done
		

		testCrediterDebiterJoueur();// done
		testAjouterCompetition(); // il manque la exception pour le cas s'il y a "un seul competiteur"
		testMiserVainqueur(); // done

		testCrediterDebiterJoueur();// done
		testAjouterCompetition(); // done
		testMiserVainqueur(); // done
	...
	public static void testCrediterDebiterJoueur () {
        ...
        try {
            ...
            sdm.inscrireJoueur(new String("Prou"), new String("Bernard"), new String("nanard"), new String("ilesCaimans"));
            sdm.inscrireJoueur(new String("Prou"), new String("Francoise"), new String("fanfan"), new String("ilesCaimans"));
            sdm.inscrireJoueur(new String("Prou"), new String("Pascal"), new String("pascal"), new String("ilesCaimans"));
            sdm.inscrireJoueur(new String("Prou"), new String("Morgane"), new String("momo"), new String("ilesCaimans"));
            sdm.inscrireJoueur(new String("Prou"), new String("Aureliane"), new String("aure"), new String("ilesCaimans"));
            sdm.inscrireJoueur(new String("Nadou"), new String("Sylvain"), new String("zinzin"), new String("ilesCaimans"));


            // crédit  de joueurs

            sdm.crediterJoueur(new String("Prou"), new String("Bernard"), new String("nanard"), 1789, new String("ilesCaimans"));
            sdm.crediterJoueur(new String("Prou"), new String("Francoise"), new String("fanfan"), 1917, new String("ilesCaimans"));
            sdm.crediterJoueur(new String("Prou"), new String("Morgane"), new String("momo"), 1848, new String("ilesCaimans"));
            sdm.crediterJoueur(new String("Prou"), new String("Aureliane"), new String("aure"), 785, new String("ilesCaimans"));
            sdm.crediterJoueur(new String("Nadou"), new String("Sylvain"), new String("zinzin"), 1123, new String("ilesCaimans"));


            // incorrect Administrator password
            try {
                sdm.crediterJoueur("Prou", "Bernard", "nanard", 100, "ilesCaimanas");
                System.out.println("n'a pas levé l'exception");
            } catch (MetierException e) {
            } catch (Exception e) {
                System.out.println("n'a pas levé l'exception MetierException mais" + e.getClass().getName());
            }

            // password is invalid (Less than 8 characters)
            try {
                sdm.crediterJoueur("Prou", "Bernard", "Morgane", 15, "less8");
                System.out.println("n'a pas levé l'exception ");
            } catch (MetierException e) {
            } catch (Exception e) {
                System.out.println("n'a pas levé l'exception MetierException (password shorter than 8), mais" + e.getClass().getName());
            }

            // Invalid password, character é
            try {
                sdm.crediterJoueur("Prou", "Bernard", "Morgane", 15, "ilésCaimans");
                System.out.println("n'a pas levé l'exception");
            } catch (MetierException e) {
            } catch (Exception e) {
                System.out.println("n'a pas levé l'exception MetierException (password invalid (é), mais" + e.getClass().getName());
            }

            // Invalid character (,)
            try {
                sdm.crediterJoueur("Prou", "Bernard", "Morgane", 15, "ilsCaima,ns");
                System.out.println("n'a pas levé l'exception");
            } catch (MetierException e) {
            } catch (Exception e) {
                System.out.println("n'a pas levé l'exception MetierException (password invalid (,) ), mais" + e.getClass().getName());
            }

            // Somme in Jetons invalid, amount is negative
            try {
                sdm.crediterJoueur("Prou", "Bernard", "Morgane", -120, "ilesCaimans");
                System.out.println("n'a pas levé l'exception ");
            } catch (MetierException e) {
            } catch (Exception e) {
                System.out.println("n'a pas levé l'exception MetierException (somme in jetons is negative), mais" + e.getClass().getName());
            }

            // the "Prenom" is wrong but the "Nom" and the "pseudo" are right
            try {
                sdm.crediterJoueur("Prou", "Berna", "nanard", 100, "ilesCaimans");
                System.out.println("n'a pas levé l'exception");
            } catch (JoueurInexistantException e) {
            } catch (Exception e) {
                System.out.println("n'a pas levé l'exception JoueurInexistantException, mais" + e.getClass().getName());
            }
            // the Password is wrong but the "Nom" and the "prenom" are right
            try {
                sdm.crediterJoueur("Prou", "Bernard", "nana", 100, "ilesCaimans");
                System.out.println("n'a pas levé l'exception");
            } catch (JoueurInexistantException e) {
            } catch (Exception e) {
                System.out.println("n'a pas levé l'exception JoueurInexistantException, mais" + e.getClass().getName());
            ...
            // incorrect Administrator password
            try {
                sdm.debiterJoueur("Prou", "Bernard", "nanard", 100, "ilesCaimanas");
                System.out.println("n'a pas levé l'exception");
            } catch (MetierException e) {
            } catch (Exception e) {
                System.out.println("n'a pas levé l'exception MetierException passwordGestionnaire not correct, mais" + e.getClass().getName());
            }

            try {
                sdm.debiterJoueur("Prou", "Bernard", "Morgane", 15, "less8");
                System.out.println("n'a pas levé l'exception ");
            } catch (MetierException e) {
            } catch (Exception e) {
                System.out.println("n'a pas levé l'exception MetierException password shorter than 8, mais" + e.getClass().getName());
            ...
            try {
                sdm.debiterJoueur("Prou", "Bernard", "Morgane", 15, "ilésCaimans");
                System.out.println("n'a pas levé l'exception");
            } catch (MetierException e) {
            } catch (Exception e) {
                System.out.println("n'a pas levé l'exception MetierException password invalid (é), mais" + e.getClass().getName());
            ...
            try {
                sdm.debiterJoueur("Prou", "Bernard", "Morgane", 15, "ilsCaima,ns");
                System.out.println("n'a pas levé l'exception ");
            } catch (MetierException e) {
            } catch (Exception e) {
                System.out.println("n'a pas levé l'exception MetierException password invalid (,), mais" + e.getClass().getName());
            ...
            // Somme in Jetons invalid, amount is negative
            try {
                sdm.debiterJoueur("Prou", "Bernard", "Morgane", -1000, "ilesCaimans");
                System.out.println("n'a pas levé l'exception");
            } catch (MetierException e) {
            } catch (Exception e) {
                System.out.println("n'a pas levé l'exception MetierException somme in jetons is negative, mais" + e.getClass().getName());
...
/*			//Test to verify when the pseudo is not correct but the password is
			...
			catch (Exception e){System.out.println("Le test n'a pas levé MetierException mais une autre exception "+e.getClass().getName());}
